  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl glass-card overflow-hidden">
          ...
          <form onSubmit={submit} className="px-6 py-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <button type="button" onClick={() => onNavigate("forgot")} className="text-xs text-orange-500 hover:text-orange-600 transition-colors">
                  Forgot password?
                </button>
              </div>
          ...
          <div className="px-6 py-4 border-t border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-white/[0.02] text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <button type="button" onClick={() => onNavigate("signup")} className="text-orange-500 hover:text-orange-600 font-semibold transition-colors">
                Sign up free
              </button>
            </p>
          </div>
        ...
        <button type="button" onClick={onGuest} className="mt-4 w-full text-sm text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors py-2">
